...
public class Main extends Application {
    ...
    public static void main(String[] args) {
        ...
        Doctor doc1 = new Doctor(35678890,"Bernabe", "Talu", 24946014,25, 80000, 234789);
        Doctor doc2 = new Doctor(23664890,"Eduardo", "Veniabuscarajuancruz", 2223456,26, 90000, 244767);
        Doctor doc3 = new Doctor(18908998,"Gustavo","Suarez",5556668,27,100000,456788);

        Recepcionista rec = new Recepcionista(27908889, "Javier", "Perez",22845677,27, 40000);
        Recepcionista rec2 = new Recepcionista(45678908,"Leo","Messi",345678,28,40000);
